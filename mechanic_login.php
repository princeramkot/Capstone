	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav ml-auto"> <!-- ml auto is going to push up the navigation when it get maximize-->
				...
				<li class="nav-item">
					<a class="nav-link" href="#">Mechanic</a>
				</li>
				<li class="nav-item">
...
<!--login form-->
  <div class="box">
      ...
      <p> <a href="#">Forgot Password</a>.</p>
            ...
            <input type="submit" name="signin" value="Login" onclick="fun()">
...
echo $username;
echo $password;
 $qry="select * from mechanic where username='$username' and password='$password'";
 ...
 if($row<1)
 {
 	...
 	window.open("mechanic_login.php","_self");</script>
<?php }
 	...
 	$_SESSION['uid']=$id;
 	?><script>
 	window.open("show_request1.php","_self");</script>
<?php 
 }
